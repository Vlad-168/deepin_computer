    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnlog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (log.getText().toString().equals("vlad") && (pass.getText().toString().equals("qwerty"))){
                    Toast.makeText(getApplicationContext(),"vlad-admin",Toast.LENGTH_LONG).show();
                    Intent successful = new Intent(login.this,
                            base.class);
